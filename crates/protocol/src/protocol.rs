...
// #[derive(Debug, Clone)]
// pub enum Command<T: CommandItem> {
//     Command(T),
//     Reponse(T),
// }
...
//     ChangeHeight(Command<ChangeHeight, (), MoveState>),
//     /// desk: 0x03
//     ReportHeight(Command<ReportHeight, (), f32>),
//     /// controller: 0x01
...
//             SourceChangeHeight::DESK_HEIGHT_PREFIX => Self::ChangeHeight(
//                 SourceChangeHeight::Command(ChangeHeight::read_from(packet)?),
//             ),
//             SourceChangeHeight::CONTROLLER_HEIGHT_PREFIX => {
//                 Self::ChangeHeight(SourceChangeHeight::Response {
